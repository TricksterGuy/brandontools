...
echo >&2 "Installing wxwidgets 3.0 and magick++..."
sudo apt-get install libwxbase3.0-0-unofficial libwxbase3.0-dev libwxgtk3.0-0-unofficial libwxgtk3.0-dev wx3.0-headers wx-common libmagick++-dev libmagickcore-dev libmagickwand-dev

echo >&2 "Building brandontools..."
make

echo >&2 "Installing brandontools..."
gksu make install
